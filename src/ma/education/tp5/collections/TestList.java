...
public class TestList {
	...
	public static void main(String[] args) {
		...
		// Affichage en utilisant la boucle for avancee
		for(Integer e :list1){
		...
		//Boucler sur la liste et afficher le carre des element de la liste s�il est superieur a 37
		...
		//le resultat de l�execution de la liste  precedente: 
		//5
		//10
		//10
		//15
